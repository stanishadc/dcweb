...
export default function B2BTravel() {    
    return (
        <div>
            <MetaTags>
            <title>B2B Travel Software for Travel Agencies and Travel Companies</title>
            ...
            <div className="single-services-page area-padding">
                <div className="container">
                    <div className="row">
                        <SiderBar pagename={"B2BTravels"}></SiderBar>
                        {/* Start service page */}
                        <div className="col-md-8 col-sm-8 col-xs-12">
                            <div className="row">
                                <h3>B2B Travel Agency Software</h3>
                                <div className="col-md-12 col-sm-12 col-xs-12">
